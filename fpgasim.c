...
#define NUM_GPIO_INPUT 6
#define NUM_GPIO_OUTPUT 6
...
DEFINE_GPIO_OUTPUT_VALUE_CHANGE_CB(4);
DEFINE_GPIO_OUTPUT_VALUE_CHANGE_CB(5);
...
PLI_INT32 init_stage_1_cb(p_cb_data cb_data)
{
    ...
    REGISTER_GPIO_OUTPUT_VALUE_CHANGE_CB(4, nets);
    REGISTER_GPIO_OUTPUT_VALUE_CHANGE_CB(5, nets);
